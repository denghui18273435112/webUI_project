...
def driver():
   #前置-成功登录
    ...
    while True:
            if test_login["url"] == "http://tp.safetycms.giiatop.com/#/Login":
                ...
                if driver.current_url == "http://tp.safetycms.giiatop.com/#/StatisticsOverview":
                    break
            else:
                ...
                if driver.current_url == "http://192.168.1.202:8117/#/StatisticsOverview":
                    break
